                        ...
                        if(docs.length === 0){
                            ...
                            collection.update(
                                ...
                                {$set:
                                {
                                    ...
                                    "DataCenters.$.kwFY16_nq": req.body.kwRequired_2016_nq,
                                    "DataCenters.$.kwFY17_nq": req.body.kwRequired_2017_nq,
                                    "DataCenters.$.kwFY18_nq": req.body.kwRequired_2018_nq,
                                    "DataCenters.$.kwFY19_nq": req.body.kwRequired_2019_nq,
                                    "DataCenters.$.kwFY20_nq": req.body.kwRequired_2020_nq,
                                    "DataCenters.$.kwFY21_nq": req.body.kwRequired_2021_nq,
                                    "DataCenters.$.kwFY22_nq": req.body.kwRequired_2022_nq,
                                    "DataCenters.$.kwFY23_nq": req.body.kwRequired_2023_nq,
                                    "DataCenters.$.kwFY24_nq": req.body.kwRequired_2024_nq,
                                    "DataCenters.$.kwFY25_nq": req.body.kwRequired_2025_nq,
                                    ...
                                    "DataCenters.$.cbFY16_nq": req.body.cbRequired_2016_nq,
                                    "DataCenters.$.cbFY17_nq": req.body.cbRequired_2017_nq,
                                    "DataCenters.$.cbFY18_nq": req.body.cbRequired_2018_nq,
                                    "DataCenters.$.cbFY19_nq": req.body.cbRequired_2019_nq,
                                    "DataCenters.$.cbFY20_nq": req.body.cbRequired_2020_nq,
                                    "DataCenters.$.cbFY21_nq": req.body.cbRequired_2021_nq,
                                    "DataCenters.$.cbFY22_nq": req.body.cbRequired_2022_nq,
                                    "DataCenters.$.cbFY23_nq": req.body.cbRequired_2023_nq,
                                    "DataCenters.$.cbFY24_nq": req.body.cbRequired_2024_nq,
                                    "DataCenters.$.cbFY25_nq": req.body.cbRequired_2025_nq,
                                    ...
                                    "DataCenters.$.assetAndConfigurationManagement": req.body.assetAndConfigurationManagement,
                                    "DataCenters.$.enterpriseServiceDesk": req.body.enterpriseServiceDesk,
                                    "DataCenters.$.firewall": req.body.firewall,
                                    "DataCenters.$.clientSiteLocalSupport": req.body.clientSiteLocalSupport,
                                    "DataCenters.$.loadBalancers": req.body.loadBalancers,
                                    "DataCenters.$.operationalServiceManagement": req.body.operationalServiceManagement,
                                    "DataCenters.$.proxy": req.body.proxy,
                                    "DataCenters.$.remoteManagementServices": req.body.remoteManagementServices,
                                    "DataCenters.$.dns": req.body.dns,
                                    "DataCenters.$.serviceIntegrationAndManagement": req.body.serviceIntegrationAndManagement,
                                    "DataCenters.$.dataCenterBasedTouchLabor": req.body.dataCenterBasedTouchLabor,
                                    "DataCenters.$.serviceRequestManagement": req.body.serviceRequestManagement,
                                    "DataCenters.$.agilityPlatform": req.body.agilityPlatform,
                                    "DataCenters.$.bigDataAndAnalytics": req.body.bigDataAndAnalytics,
                                    "DataCenters.$.mobilityAndSocial": req.body.mobilityAndSocial,
